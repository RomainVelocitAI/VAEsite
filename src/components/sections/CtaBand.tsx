    ...
    <section className="relative py-14 sm:py-20 md:py-28 overflow-hidden">
      <div className="absolute inset-0">
        <Image
          ...
          sizes="100vw"
        />
        <div className="absolute inset-0 bg-marron-pourpre/65" />
      </div>

      <Container className="relative z-10">
        <AnimateOnScroll variant="scaleIn">
          <div className="text-center max-w-xl mx-auto">
            <h2 className="font-titre text-[24px] sm:text-[28px] md:text-[36px] font-bold text-blanc tracking-tight">
              {t("title")}
            </h2>
            <div className="mt-4 h-[2px] w-12 bg-chamois mx-auto" />
            <p className="mt-5 text-[19px] font-accent italic text-chamois/80">
              {t("description")}
            </p>
            <div className="mt-8">
